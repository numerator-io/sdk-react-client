(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('axios'), require('axios-case-converter'), require('react/jsx-runtime'), require('react')) :
    typeof define === 'function' && define.amd ? define(['exports', 'axios', 'axios-case-converter', 'react/jsx-runtime', 'react'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Numerator = {}, global.axios$1, global.applyCaseMiddleware, global.jsxRuntime, global.React));
})(this, (function (exports, axios$1, applyCaseMiddleware, jsxRuntime, React) { 'use strict';
                ...
                try {
                    ...
                    switch ((_a = response.data) === null || _a === void 0 ? void 0 : _a.valueType) {
                        case exports.FlagValueTypeEnum.STRING:
                            typeKey = 'stringValue';
                            break;
                        case exports.FlagValueTypeEnum.LONG:
                            typeKey = 'longValue';
                            break;
                        case exports.FlagValueTypeEnum.DOUBLE:
                            typeKey = 'doubleValue';
                            break;
                        case exports.FlagValueTypeEnum.BOOLEAN:
