(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const END_POINT_FEATURE_FLAG_COLLECTION_POOLING = `${END_POINT_BASE}/polling`;
    ...
    const NumeratorProvider = ({ children, configClient, defaultContext, loadPolling = true }) => {
        ...
        const [activeTimeInterval, setActiveTimeInterval] = react.useState(loadPolling);
        const fetchPollingFeatureFlag = () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield numeratorClient.fetchPoolingFlag(defaultContext, currentEtag);
