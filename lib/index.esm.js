    ...
    fetchPollingFlag(context, eTag) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return { flags: (_a = response.data) === null || _a === void 0 ? void 0 : _a.flags, etag: response.headers.get('ETag') };
            }
            catch (error) {
...
export { FlagStatusEnum, FlagValueTypeEnum, NumeratorClient, NumeratorProvider, addMockedFlag, mockFlags, removeMockedFlag, resetNumeratorMocks, useMockNumeratorProvider, useNumeratorContext };
