 ...
 */
var axios = applyCaseMiddleware(axios$1.create());
            ...
            try {
                ...
                if (axiosResponse) {
                    const errorResponse = {
                        ...
                        errorCode: ((_b = axiosResponse.data) === null || _b === void 0 ? void 0 : _b.errorCode) || 'unknown_error',
    ...
    featureFlagValueByKey(request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let typeKey;
                switch ((_a = response.data) === null || _a === void 0 ? void 0 : _a.valueType) {
                ...
                const newValue = ((_b = response.data) === null || _b === void 0 ? void 0 : _b.value)[typeKey];
                if (!newValue) {
                    throw new Error('Cannot cast data');
                }
                const newResponse = Object.assign(Object.assign({}, response.data), { value: newValue });
                return newResponse;
            }
            catch (error) {
...
const flagIsOn = (featureFlagsValue, key) => {
    var _a;
    return ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.status) === FlagStatusEnum.ON;
};
/**
...
const flagIsOff = (featureFlagsValue, key) => {
    ...
    return !flag || (flag === null || flag === void 0 ? void 0 : flag.status) === FlagStatusEnum.OFF;
};
/**
...
const flagEqualsValue = (featureFlagsValue, key, value) => {
    var _a;
    return ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.value) === value;
};
/**
...
const flagIsOnShouldRenderComponent = (featureFlagsValue, key, onComponent) => {
    var _a;
    return ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.status) === FlagStatusEnum.ON ? onComponent : React.createElement(React.Fragment);
};
/**
...
const flagIsOnShouldCallback = (featureFlagsValue, key, onCallback) => {
    ...
    const isOn = ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.status) === FlagStatusEnum.ON;
...
const flagIsOffShouldCallback = (featureFlagsValue, key, offCallback) => {
    ...
    const isOff = !featureFlagsValue[key] || ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.status) === FlagStatusEnum.OFF;
...
const flagEqualsValueShouldCallback = (featureFlagsValue, key, value, equalsCallback) => {
    ...
    const isEqualsValue = ((_a = featureFlagsValue[key]) === null || _a === void 0 ? void 0 : _a.value) === value;
...
const NumeratorProvider = ({ children, configClient, loadAllFlagsConfigOnMount, loadFeatureFlagsValueOnMount, }) => {
    ...
    const [featureFlagsConfig, setFeatureFlagsConfig] = useState({});
    const [featureFlagsValue, setFeatureFlagsState] = useState({});
...
export { FlagStatusEnum, FlagValueTypeEnum, NumeratorClient, NumeratorProvider, deepCopy, flagEqualsValue, flagEqualsValueShouldCallback, flagEqualsValueShouldRenderComponent, flagIsOff, flagIsOffShouldCallback, flagIsOffShouldRenderComponent, flagIsOn, flagIsOnShouldCallback, flagIsOnShouldRenderComponent, mapArrayToRecord, sleep, useNumeratorContext, withTimeout };
